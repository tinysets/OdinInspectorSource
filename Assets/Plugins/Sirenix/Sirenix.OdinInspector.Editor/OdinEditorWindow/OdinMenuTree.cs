#if UNITY_EDITOR
//-----------------------------------------------------------------------// <copyright file="OdinMenuTree.cs" company="Sirenix IVS"> // Copyright (c) Sirenix IVS. All rights reserved.// </copyright>//-----------------------------------------------------------------------
//-----------------------------------------------------------------------
...
namespace Sirenix.OdinInspector.Editor
{
    ...
    public class OdinMenuTree : IEnumerable
    {
        ...
        public void DrawMenuTree()
        {
            ...
            {
                var c = this.FlatMenuTree.Count;
                for (int i = 0; i < c; i++)
                {
                    this.FlatMenuTree[i].DrawMenuItem(0);
                }
            }
            else
            {
                var c = this.MenuItems.Count;
                for (int i = 0; i < c; i++)
                {
                    this.MenuItems[i].DrawMenuItems(0);
                }
            }
