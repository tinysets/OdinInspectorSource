#if UNITY_EDITOR
//-----------------------------------------------------------------------// <copyright file="AbstractTypeUnityPropertyDrawer.cs" company="Sirenix IVS"> // Copyright (c) Sirenix IVS. All rights reserved.// </copyright>//-----------------------------------------------------------------------
//-----------------------------------------------------------------------
...
namespace Sirenix.OdinInspector.Editor
{
        ...
        where T : TDrawnType
    {
        ...
        protected override void DrawPropertyLayout(GUIContent label)
        {
            ...
            float height = this.drawer.GetPropertyHeight(unityProperty.Copy(), label);
